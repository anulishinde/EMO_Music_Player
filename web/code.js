...
function play(elem){
	...
	document.getElementById("main_slider").addEventListener("timeupdate", timeupdt(document.getElementById("main_slider")));
...
function rand_play(){
	...
	document.getElementById("sel").src= pa;
	var audio = document.getElementById("main_slider");
	
	audio.load();
	audio.play();
	audio.addEventListener("timeupdate", timeupdt(document.getElementById("main_slider")));
